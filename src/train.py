...
train_dataset = EgoHandsDataset(data_folder, data_limit=100, transforms=transforms)
val_dataset = EgoHandsDataset(data_folder, mode='val', data_limit=100, transforms=transforms)
